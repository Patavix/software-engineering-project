...
const routes = [
  ...
  // admin登录
  {
    ...
    meta: { title: "admin登录", hidden: "false" },
  },
  // 发布
  {
    name: "post-create",
    ...
    meta: { title: "信息发布", requireAuth: true, hidden: "true" },
  },
  // 编辑
  {
    name: 'topic-edit',
  ...
  // 用户设置
  {
    ...
    meta: { title: '设置', requireAuth: true, hidden: "true" }
  },
  {
    path: "/404",
    name: "404",
